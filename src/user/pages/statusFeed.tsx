...
const StatusFeed = () => {
    ...
    /* ---------------- RENDER ---------------- */
    return (
        <div className="bg-gray-50 no-copy w-full h-[calc(100vh-60px)] md:px-10 px-2 py-5 font-inter text-gray-600  md:font-normal font-mediumoverflow-hidden border-t flex">
