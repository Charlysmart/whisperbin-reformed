...
const JoinRoom = () => {
    ...
    return (
        <>
            <SEO 
                title="Join Chat Room — WhisperBin"
                description="Join a WhisperBin chat room and start anonymous conversations instantly."
                url={`${import.meta.env.VITE_SITE_URL}/join_room`}
            />
