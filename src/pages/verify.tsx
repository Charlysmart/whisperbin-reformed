                ...
                <div className="lg:w-[40%] md:w-[70%] w-[90%] h-fit text-gray-600 border border-gray-200 bg-white hover:shadow rounded-2xl md:px-10 px-3 py-10 font-inter font-medium">
                    ...
                    <form className="flex flex-col md:gap-10 gap-5">
                        ...
                        <div className="px-10 space-y-6">
                            <Button label="Verify Account" buttonType="colored" extraClass="w-full md:text-[20px] font-medium shadow-2xl shadow-blue-200" />
                            <hr className="border-gray-200" />
                        </div>
                    </form>
                    <div className="text-[#4b5563] md:text-[16px] text-[15px] text-center space-y-3 mt-10">
                        <p>Didn't receive any code?</p>
                        <p className="text-blue-500 inline-flex gap-2 font-semibold md:text-[18px] text-[16px]"><RotateCwIcon /> Resend Verification Code</p>
                        <p>Code expires in <span className="font-semibold">5:00</span></p>
                    </div>
