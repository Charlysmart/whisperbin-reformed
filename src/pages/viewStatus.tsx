            ...
            <div className="flex justify-end gap-3 mb-7" style={{width : `${left}%`, minWidth: "85%",}}>
                ...
                <div className="space-y-3 w-full">
                    <div className="bg-gray-50 md:p-5 p-3 rounded-2xl space-y-3">
                        ...
                        <p className="md:text-[16px] text-[14px]">{comment}</p>
                    </div>
...
const ViewStatus = () => {
    return (
        <div className={`bg-gray-50 w-full flex flex-col gap-10 items-center md:px-0 px-2 py-5 h-[calc(100vh-60px)] font-inter overflow-y-auto border-t border-gray-100 *:md:w-[80%] *:w-full`}>
            <div className="flex text-gray-500 text-[16px] font-medium hover:text-blue-500 cursor-pointer">
            ...
            <div className="bg-white shadow-xl text-gray-700 w-full rounded-2xl md:p-6 py-6 px-3 space-y-5">
                ...
                <p className="md:text-[18px] text-[14px]">Just sent my first anonymous message! Feeling empowered by the privacy AnonyText offers. This platform is amazing for sharing thoughts without judgment.</p>
            ...
            <div className="bg-white shadow-xl w-full text-gray-700 rounded-2xl md:p-6 py-6 px-3 space-y-5">
                ...
                <form className="space-y-5">
                    <div className="w-full flex gap-5">
                        ...
                        <textarea placeholder="Share your thoughts anonymously..." className="w-full h-20 border-2 border-gray-400 rounded-xl md:text-[16px] text-[12px] p-3 resize-none"/>
                    </div>
                    <div className="flex md:justify-between justify-center flex-wrap gap-2">
                        <div className="text-gray-700 md:text-[14px] text-[12px] flex items-center gap-1">
                            <Lock size={16} />
