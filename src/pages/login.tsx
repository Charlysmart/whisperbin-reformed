            ...
            <section className="flex w-full justify-center items-center py-5">
                <div className="lg:w-[40%] md:w-[70%] w-[90%] h-fit border border-gray-200 bg-white hover:shadow rounded-2xl md:px-10 px-3 py-10 font-inter">
                    ...
                    <div className=" mb-4 text-center flex flex-col gap-3">
                        <p className="md:text-[30px] text-[18px] font-bold">Login to AnonyText</p>
                    ...
                    <p className="text-[14px] mt-7 text-end text-blue-500 font-medium">Forgot password?</p>
                    ...
                    <div className="text-[14px] space-y-5">
                        <p>Don't have an account yet? <span className="text-blue-500 font-medium">Register here</span></p>
                        <p>Your privacy is our priority. Read our <span className="text-blue-500 font-medium">Privacy Policy.</span></p>
                    </div>
                </div>
            </section>
        </div>
