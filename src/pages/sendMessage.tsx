...
const SendMessage = () => {
    return (
        <div className={`w-full h-[calc(100vh-60px)] md:px-10 px-3 py-5 font-inter overflow-y-auto space-y-5`}>
            ...
            <div className="flex justify-center py-5">
                <div className="lg:w-[55%] md:w-[90%] w-full border border-gray-100 rounded-md p-5 space-y-5">
                    <p className="text-[14px]">Compose your anonymous message below. Your identity will remain hidden.</p>
                    ...
                    <p className="text-[11px] p-2 border border-gray-200 bg-gray-100 rounded-md">Your message will be delivered securely and anonymously. The recipient will not know your identity.</p>
