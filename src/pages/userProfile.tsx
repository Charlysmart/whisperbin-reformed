        ...
        <div className="bg-white w-full h-[calc(100vh-60px)] md:px-10 px-3 py-5 font-inter text-gray-600 font-medium overflow-y-auto border-t border-gray-100">
            ...
            <div className="flex flex-col gap-3 mt-5 border border-gray-100 md:p-5 px-2 py-5 rounded-md">
                ...
                <div className="border-2 border-gray-200 w-full px-3 py-1 bg-gray-100 flex justify-between items-center rounded-md">
                    <input type="text" name="messageLink" id="messageLink" readOnly value="anonytext.app/u/alice_s_anon" className="md:text-[14px] text-[13px] outline-0" />
            ...
            <div className="flex flex-col gap-3 mt-5 border border-gray-100 md:p-5 px-2 py-5 rounded-md">
                ...
                <div className="space-y-5">
                    <div className="flex justify-between items-center">
                        <p className="text-[14px]">Email Notification</p>
