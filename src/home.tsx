    ...
    return (
        <main className="w-full h-full space-y-10 font-inter">
            ...
            <section className="bg-secondary flex flex-col items-center w-full py-10 px-2 space-y-10">
                ...
                <div className="w-[90%] flex md:flex-row flex-col md:gap-0 gap-7 md:items-stretch items-center justify-between">
                    <div className="bg-white md:w-[32%] w-full rounded-md p-10 shadow-md shadow-alpha-primary-shadow transition duration-500 hover:-translate-y-2 features relative overflow-hidden space-y-3">
            ...
            <section className="bg-gradient-hero flex flex-col items-center">
                <div className="lg:w-[50%] md:w-[70%] flex flex-col items-center text-center text-ash space-y-7 px-2 py-15">
                ...
                <footer className="flex md:flex-row flex-col justify-between items-center w-[80%] border-t border-alpha-card-border py-5 md:gap-0 gap-3">
